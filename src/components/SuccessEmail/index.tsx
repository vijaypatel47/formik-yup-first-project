...
const SuccessEmail: React.FC = () => {
    ...
    return(
      <div className="h-screen w-full bg-black flex flex-col items-center justify-center p-10 lg:text-lg">
          <div className="h-full w-full flex flex-col items-center justify-center">
            ...
            <div className="bg-gray-800 rounded-md flex flex-col items-center justify-center px-10 py-10 my-5 w-[100%] md:w-[80%] lg:w-[35%] xl:[30%] h-[550px]">
                ...
                <h1 className="text-gray-200 font-bold text-lg">Success!!</h1>
                <p className="text-gray-500 py-2">Your email has been verified. Please proced to the login page</p>
                <button type="submit" className="mb-5 py-2 px-10 rounded-2xl bg-gray-500 text-gray-200 hover:bg-purple-500"><Link to="/login">Continue</Link></button>
            </div>
          </div>
        </div>
    )
